# Android-Archiver
Windows application that helps you copy files from your Android device to your computer. Much faster than using Windows File Explorer. Android Platform Tools are official and provided unmodified. If you found this useful, please drop a ⭐- it means a lot!
